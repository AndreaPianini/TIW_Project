...
public class AppelloDAO {
	...
	public List<Appelli> GetAppelliByCorsoAndDocente(int docID, int corso) throws SQLException {
		List<Appelli> appelli = new ArrayList<>();
	...
	public Appelli GetAppelloByVerbale(int verID) throws SQLException {
